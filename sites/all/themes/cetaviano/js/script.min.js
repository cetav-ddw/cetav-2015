        ...
        var renderEmployabilityGraph = function() {
            ...
            function init() {
                ...
                function createWaves(idx, hasPercent) {
                    ...
                    var graphPercent = $('<div class="percent"></div>').append($('<div class="percent__inner"></div>').append([ percentNum, percentSign ]));
...
(function($) {
    jQuery(document).ready(function($) {
        $(".btn__modal--open").click(function(){
            $("#banner-modal").addClass("modal--open");
            console.log('asdas');
        });
        $(".btn__modal--close").click(function(){
            $("#banner-modal").removeClass("modal--open");
            console.log('fuuuck');
        });
    });
})(jQuery);
